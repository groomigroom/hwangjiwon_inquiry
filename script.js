...
let box_four_main = document.querySelector(".box_four_main");
let box_four_main_out = document.querySelector(".box_four_main_out");

box_four.addEventListener("click", () => box_four_main.classList.add("on"));
box_four_main_out.addEventListener("click", () => box_four_main.classList.remove("on"));

/*box_five function*/

let box_five = document.querySelector(".box_five");
let box_five_main = document.querySelector(".box_five_main");
let box_five_main_out = document.querySelector(".box_five_main_out");
